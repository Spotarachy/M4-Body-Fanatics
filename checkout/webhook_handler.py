...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        """
        Sending the uesd a confirmation email
        """
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        # Clean data the shipping details
        ...
        if username !='AnonymousUser':
            ...
            if save_info:
                ...
                profile.default_street_address2t=shipping_details.address.line2,
    ...
    def handle_payment_intent_failed(self, event):
        """ 
        Handle a payment_intent.payment_failed webhook form Stripe
        """
        return HttpResponse(
            content=f'Webhook received: {event["type"]}',
            status=200)